...
| TC-06 | Swipe-to-favourite | Real device (either) | In the contact list, swipe left on a contact row (same gesture as TC-05). | Both Favourite (dark green, left button) and Archive (red, right button) are revealed. Tap the Favourite button to toggle the star. Star appears on the contact row. | |
