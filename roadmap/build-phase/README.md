...
| P12-06 | 12 | In Progress | P1 | P12-03 | Unassigned | In-app done: header/sidebar badges, /shares accept(→navigate)/decline, invite-to-register linking. Email deferred (needs provider) |
