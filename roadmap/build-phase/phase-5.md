...
- Implementation Notes:
  ...
  - Favorites now exist as a visible consumer feature in the main workspace, and the v1 product decision is to keep them as Kontax-local preference state rather than attempt first-wave CardDAV translation.
