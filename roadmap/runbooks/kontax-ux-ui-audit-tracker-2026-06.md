...
| UX-002 | Logged | Medium | App navigation | `/contacts?tab=overview` | Tablet | Tablet left rail is too dense and competes with overview content | [P34U-01](../build-phase/p34u-01-tablet-overview-nav-density.md) |  |  | Consider progressive disclosure |
...
| UX-004 | Logged | Medium | Create contact | `/contacts/new` | Mobile | Phone control is icon-only and underlabelled | [P34U-03](../build-phase/p34u-03-phone-country-selector-clarity.md) |  |  | Accessibility and clarity issue |
...
| UX-006 | Logged | Medium | Sync | `/sync?account=cmq446geh0001j5uhqoo4ps11` | Mobile | Sync history is too repetitive and hard to scan on small screens | Pending |  |  | Mobile layout compression needed |
...
| UX-008 | Logged | Medium | Merge review | `/merge/manual` | Mobile | Manual merge entry layout is still desktop-shaped | [P34U-04](../build-phase/p34u-04-manual-merge-searchable-pickers.md) |  |  | Fixed three-column selector row needs mobile adaptation |
...
| UX-011 | Logged | Medium | Merge review | `/merge/manual` | Mobile, Desktop | Merge pickers imply search but behave like huge native dropdowns | [P34U-04](../build-phase/p34u-04-manual-merge-searchable-pickers.md) |  |  | Replace with true typeahead or combobox search |
