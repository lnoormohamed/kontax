...
const main = async () => {
  ...
  const flagship = await db.contact.create({
    data: base({
      ...
      emailEntries: [
        { label: "work", value: "amara@okafor.health", isPrimary: true },
        { label: "personal", value: "mara.okafor@gmail.com" },
      ],
      phone: "+2348031234567",
      phoneEntries: [
        { label: "mobile", value: "+2348031234567", isPrimary: true },
        { label: "clinic", value: "+2349087654321" },
      ],
      company: "Orbit Health",
      phoneticCompany: "OR-bit",
      jobTitle: "Chief Medical Officer",
      website: "https://orbit.health/team/amara",
      websiteEntries: [{ label: "work", value: "https://orbit.health/team/amara", isPrimary: true }],
      birthday: "1984-03-22",
      address: "14 Adetokunbo Ademola Cres, Lagos, Lagos NG",
      addressEntries: [
        {
          label: "home",
          formatted: "14 Adetokunbo Ademola Cres, Lagos, Lagos NG",
          isPrimary: true,
          cityOrTown: "Lagos",
          countryOrRegion: "NG",
        },
      ],
      significantDates: [{ label: "work anniversary", date: "2019-09-01", isPrimary: true }],
      relatedPeople: [{ relationship: "assistant", name: "Tunde Bello" }],
