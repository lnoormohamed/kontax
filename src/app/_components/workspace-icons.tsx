...
const PATHS: Record<string, string[]> = {
  ...
  phone: ["M5 4h3l2 5-2.2 1.3a10 10 0 005 5L14 13l5 2v3a2 2 0 01-2 2A15 15 0 013 6a2 2 0 012-2z"],
  mail: ["M3.5 6h17v12h-17z", "M3.5 6.5 12 13l8.5-6.5"],
  share: ["M6 12v7a1 1 0 001 1h10a1 1 0 001-1v-7", "M12 3v12", "M8 7l4-4 4 4"],
