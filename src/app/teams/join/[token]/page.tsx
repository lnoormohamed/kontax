        ...
        {!valid || !member ? (
          <>
            ...
            <p className="mx-auto mt-1 max-w-sm text-[13px] text-[#8b938c]">
              It may have expired or already been used. Ask a team admin to send a new one.
            </p>
            <Link
          ...
          <>
            ...
            <h1 className="mt-1 text-[19px] font-semibold">Join {member.group.name}</h1>
            <p className="mx-auto mt-1.5 max-w-sm text-[13px] text-[#5c655e]">
              {member.group.owner.name?.trim() ?? member.group.owner.email} invited you to this team
              on Kontax. Your private contacts stay private.
            </p>
